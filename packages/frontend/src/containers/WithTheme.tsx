...
import {layoutActions} from 'src/features/layout/layout.slice';
...
class WithTheme extends React.Component<LayoutContainerProps & IOtherProps> {
  public render() {
...
const mapStateToProps = ({ appLayout }: RootState) => ({
  theme: appLayout.theme
});
